                ...
                <div class="tab-content col-lg-9 col-md-8">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="order-total"><span>${{ $item->total }} for {{
                                            App\Models\Order::where('cookie', $item->cookie)->count()}} items</span>
                                    </td>
                                    <td class="order-action"><a href="{{ url('front/order/view') }}/{{ $item->cookie }}"
                    ...
                    <div class="tab-pane" id="account">
                        <form action="{{ route('front.profile.update') }}" method="post" class="form"
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                            value="{{ Auth::user()->facebook ? Auth::user()->facebook : "" }}"
                                            class="form-control" name="facebook">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Instragram</label>
                                        <input type="text"
                                            value="{{ Auth::user()->instragram ? Auth::user()->instragram : "" }}"
                                            class="form-control" name="instragram">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text"
                                            value="{{ Auth::user()->linkedin ? Auth::user()->linkedin : "" }}"
                                            class="form-control" name="linkedin">
                                    </div>
                                    <div class="col-sm-6">
                                        <label>Twitter</label>
                                        <input type="text"
                                            value="{{ Auth::user()->twitter ? Auth::user()->twitter : "" }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>Phone</label>
                                        <input type="text" value="{{ Auth::user()->phone ? Auth::user()->phone : "" }}"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select id="my-select" class="form-control" name="blood">
                                            ...
                                            <option {{ Auth::user()->blood == "o+" ? "selected" : "" }} value="{{
                                                Auth::user()->blood ? Auth::user()->blood : "" }}">O+</option>
                                            <option {{ Auth::user()->blood == "a+" ? "selected" : "" }} value="{{
                                                Auth::user()->blood ? Auth::user()->blood : "" }}">A+</option>
                                            <option {{ Auth::user()->blood == "b+" ? "selected" : "" }} value="{{
                                                Auth::user()->blood ? Auth::user()->blood : "" }}">B+</option>
                                            <option {{ Auth::user()->blood == "ab+" ? "selected" : "" }} value="{{
                                                Auth::user()->blood ? Auth::user()->blood : "" }}">AB+</option>
                                            <option {{ Auth::user()->blood == "o-" ? "selected" : "" }} value="{{
                                                Auth::user()->blood ? Auth::user()->blood : "" }}">O-</option>
                                            <option {{ Auth::user()->blood == "a-" ? "selected" : "" }} value="{{
                                                Auth::user()->blood ? Auth::user()->blood : "" }}">A-</option>
                            ...
                            <button type="submit" name="btn_name" value="password_change" class="btn btn-primary">SAVE
                                CHANGES</button>
                        </form>
                    </div>
                </div>
