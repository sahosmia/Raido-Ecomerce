...
@section('page_title', 'Coupon Recycle Bin')

@section('content')
    <div class="page-header">
        <div>
            <h3>Coupon Recycle Bin</h3>
    ...
    <div class="card border border-primary">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Trashed Coupon Items</h5>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center text-danger">No trashed coupons found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <div class="card-footer bg-primary text-white">
            <h5 class="mb-0">Total Trashed Coupons: {{ $cupons->total() }}</h5>
        </div>
    </div>
@endsection