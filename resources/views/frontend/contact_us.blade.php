                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 ls-m mb-4">
                            <div class="grey-section d-flex align-items-center h-100">
                                <div>
                                    ...
                                    <p class="mb-4">
                                        <a href="mailto:support@your-domain.com">support@your-domain.com</a><br>
                                        <a href="mailto:help@your-domain.com">help@your-domain.com</a><br>
                                        <a href="#">Sale</a>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-6 d-flex align-items-center mb-4">
                            <div class="w-100">
                                <x-alert />
                                <form class="pl-lg-2" action="{{ route('messages.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <button type="submit" class="btn btn-dark btn-rounded">Send Message<i
                    ...
                    <div class="row cols-sm-2 cols-lg-4">
                        <div class="store">
                            <figure class="banner-radius">
                                <img src="{{ asset('frontend/images/subpages/store-1.jpg') }}" alt="store" width="280"
                                    height="280">
                        ...
                        <div class="store">
                            <figure class="banner-radius">
                                <img src="{{ asset('frontend/images/subpages/store-2.jpg') }}" alt="store" width="280"
                                    height="280">
                        ...
                        <div class="store">
                            <figure class="banner-radius">
                                <img src="{{ asset('frontend/images/subpages/store-3.jpg') }}" alt="store" width="280"
                                    height="280">
                        ...
                        <div class="store">
                            <figure class="banner-radius">
                                <img src="{{ asset('frontend/images/subpages/store-4.jpg') }}" alt="store" width="280"
                                    height="280">
